...
router.get('/:id/tasks', (req, res) => {
    ...
    .then(tasks => {
        if(tasks) {
            ...
            res.status(404).json({message: 'Could not find tasks for the  project with the given id'})
        }
    })
    .catch(err => {
...
router.get('/:id/resources', (req, res) => {
    ...
    .then(resources => {
        if(resources) {
            ...
            res.status(404).json({message: 'Could not find resources for the  project with the given id'})
        }
    })
    .catch(err => {
        console.log(err)
