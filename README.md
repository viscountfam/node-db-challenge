...
- [x] Explain the difference between `Relational Databases` and `SQL`.
  SQL is the language that we use to make queries within databases while relational databases are databases that store values on tables with keys that allow us to understand the data more easily

- [x] Why do tables need a `primary key`?
    We need to give tables a primary key to avoid anomalies and give SQL an unique value for each piece of data
